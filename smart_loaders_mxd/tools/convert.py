...
# Vendored verbatim from city96/ComfyUI-GGUF. See smart_loaders_mxd/UPSTREAM.md
# for the sync baseline and procedure. Do not hand-edit; port upstream diffs instead.
# Only detect_arch() is used at runtime (loader.py's compat-mode fallback); the
# rest of this module (CLI conversion script) is kept intact for parity with upstream.
import os
import gguf
import torch
import logging
