...
@routes.get('/loraloader-mxd/api/{type}/info')
...
@routes.get('/loraloader-mxd/api/{type}/info/refresh')
...
@routes.get('/loraloader-mxd/api/{type}/info/clear')
...
@routes.post('/loraloader-mxd/api/{type}/info')
...
@routes.get('/loraloader-mxd/api/{type}/img')
